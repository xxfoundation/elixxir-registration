...
// 2021-03-19 14:58:20.3632123 -0700 PDT m=+0.419364901
package cmd

const GITVERSION = `5b38030 removed the offline nodes system from scheduling and integrated it into the pruned nodes system`
const SEMVER = "2.1.2"
