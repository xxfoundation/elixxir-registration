...
// 2020-06-01 12:28:36.3812516 -0700 PDT m=+0.122583001
package cmd

const GITVERSION = `bd6d938 Fix version.IsCompatible() logic for empty version strings and add additional tests for IsCompatible()`
const SEMVER = "1.1.0"
